...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        botonRestaurante= (ImageButton) findViewById(R.id.btRest);

    }



    public void onClickFarmacias(View v){
    ...
    public void findPlaces(String placeType){
        ...
        Call<NearByApiResponse> call = Controladora.getApp().getApiService().getPlaces(placeType, location.getLatitude() + "," + location.getLongitude(), PROXIMITY_RADIUS);
    ...
    public void onConnectionFailed(@NonNull ConnectionResult connectionResult) {
        Toast.makeText(this,"No se puede conectar a la Api de Goggle",Toast.LENGTH_LONG).show();
    }
